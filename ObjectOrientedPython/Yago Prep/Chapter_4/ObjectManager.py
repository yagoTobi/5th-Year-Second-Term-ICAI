...
class Bank(): 
    ...
    def openAccount(self): 
        ...
        userAccountNumber = self.createAccount(userName, userStartingAmount, userPassword) # ? - Automatically added to the dict. 
    ...
    def closeAccount(self): 
        ...
        if accountBalance is not None: 
            print(f'You have ${accountBalance} in the bank. These have been withdrawn from your account.')
