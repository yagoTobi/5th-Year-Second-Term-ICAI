...
class Square(Shape):
    def __init__(self, window, maxWidth, maxHeight):
        ...
        self.rect = pygame.Rect(self.x, self.y, self.widthAndHeight)  # type: ignore
    ...
    def draw(self):
        pygame.draw.rect(self.window, self.color, self.x, self.y, self.widthAndHeight, self.widthAndHeight)  # type: ignore
