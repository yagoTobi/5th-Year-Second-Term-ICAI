...
knn_gridCV = GridSearchCV(
    estimator=knn_pipe, param_grid=hyp_grid, cv=num_folds, return_train_score=True
)
...
ConfusionMatrixDisplay.from_estimator(
    model, XTR, YTR, cmap="Greens", colorbar=False, ax=ax1, labels=[1, 0]
)
ConfusionMatrixDisplay.from_estimator(
    model, XTS, YTS, cmap="Greens", colorbar=False, ax=ax2, labels=[1, 0]
)
